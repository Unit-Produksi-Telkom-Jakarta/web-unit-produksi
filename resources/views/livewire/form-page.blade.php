<div>
    ...
    <div class="p-6 rounded-lg shadow-lg w-full">
        ...
        <div class="form-group">
            ...
            border-solid border-gray-300 rounded m-3" id="no_telfon" placeholder="No. Handphone">
        </div>
        <div class="form-group">
        ...
        @if($pic == 'repair')
        <div class="form-group">
            <label for="kendala" class="form-label inline-block mb-2 text-gray-700 mr-10">Kendala</label>
            <textarea wire:model="kendala" id="kendala" rows="3" class="form-control w-72 ml-6 border border-solid border-gray-300" placeholder="Kendala" value="null"></textarea>
        </div>
        @endif
