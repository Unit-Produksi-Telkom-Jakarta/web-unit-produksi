<div class="relative px-4 pt-5 pb-4 text-left sm:w-full sm:max-w-lg sm:p-6">
    <div class="sm:flex sm:items-start">
        ...
        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            <h3 class="text-lg font-medium leading-6 text-gray-900" id="modal-title">Konfirmasi Hapus Data</h3>
            <div class="mt-2">
                <p class="text-sm text-gray-500">Apakah anda yakin ingin hapus data ini?</p>
            </div>
        </div>
    </div>
