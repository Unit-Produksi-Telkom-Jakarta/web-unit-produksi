...
<body>
    ...
    <main class="w-3/4 h-full border border-gray-200 rounded-lg shadow-xl m-auto mt-10">
        <header class="flex justify-between align-top">
            <img src="{{ asset('/images/logo.png') }}" class="w-[100px] h-[100px]" id="logo" alt="logo_up"
                srcset="">
        </header>
        <br>
        <div id="invoice" class="w-full h-full">
            <main class="p-5 w-full">
                ...
                <h1 class="text-sm mb-5 text-center">Tanggal : {{ $date}}</h1>
                <table class="mb-10 border-collapse border border-slate-500 w-full">
                    ...
                    @else
                    <thead class="text-center">
                        <th class="border">Data not found</th>
                    </thead>
                    @endif
                    <tbody>
        ...
        <div id="invoice-button" class="m-5">
            <button class="btn btn-primary flex justify-center mt-10" onclick="printReport()">Print</button>
        </div>
    </main>
</body>
